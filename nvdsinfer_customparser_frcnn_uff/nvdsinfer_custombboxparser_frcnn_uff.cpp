...
extern "C"
bool NvDsInferParseCustomFrcnnUff (
...
extern "C"
bool NvDsInferParseCustomFrcnnUff (std::vector<NvDsInferLayerInfo> const &outputLayersInfo,
                                   NvDsInferNetworkInfo  const &networkInfo,
                                   NvDsInferParseDetectionParams const &detectionParams,
                                   std::vector<NvDsInferObjectDetectionInfo> &objectList) {
    ...
    gParams.visualizeThreshold = 0.6f;
...
CHECK_CUSTOM_PARSE_FUNC_PROTOTYPE(NvDsInferParseCustomFrcnnUff);
